...
import datadownload from '../components/JeeAdvanceData.js';
import '../styles/jeeadvancedownload.css';
import { IoMdHome } from "react-icons/io";
import Logo_img from '../images/logo.png';
import { FaAngleDown } from "react-icons/fa";
const JeeAdvanceDownload = () => {
    ...
    return (
      <div className='divboxmain'>
        ...
        <div className='divboxing'>
          <h1 className='jeeh1down'>JEE ADVANCE SOLVED PAPERS</h1>
        </div>
        <div className='divboxdd'>
          <div className='divboxd'>
            {Object.entries(datadownload).map(([year, months]) => (
              <div key={year} className='year-container'>
                <h2 onClick={() => handleYearClick(year)} className='h2box h2 h2boxadv'>
          ...
          {selectedShift && (
            <div className='shift-data advance-shift'>
              <h2 className='sdh2 sdh2adv'>{selectedShift.shift_name}</h2>
              <div className='pdfmpc' >
                <ul>
                    <li  onClick={click1}  id ='dropdownadv'>Visit PDF
                    { isBox1Visible &&
              ...
              <table className='downjeetable tableadv'>
                <thead>
                  <tr>
                    <th>S.No</th>
                    <th>Maths Link</th>
...
export default JeeAdvanceDownload