...
const RegisterForm = () => {
  ...
  //   setFormData(prevState => {
  //     const updatedFormData = { ...prevState, coaching: value };
  //     if (value === 'no') {
  //       updatedFormData.batch = '';
  //       updatedFormData.rollno = '';
  //       updatedFormData.centername = '';
  //     }
...
const handleLoginSubmit = async (e) => {
  ...
  try {
      const response = await axios.post('http://localhost:8000/login/login', loginData, { withCredentials: true });
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className='registerform'>
        ...
        <button type="submit" className ="pnrcf">Register</button>
