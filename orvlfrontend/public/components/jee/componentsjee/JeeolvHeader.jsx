        ...
        <div className='oco_sub'>
          ...
          <div className='oco_griding'>
            <div className='oco_maincard'>
              ...
              <div className='btno'>
                <button className='btn1' onClick={toggleModal1}>KNOW MORE
                </button>
                {modal1 && (
                  <div className='modal'>
                ...
                <button className='btn1' onClick={toggleModal2}>SCHEDULE</button>
                {modal2 && (
                  <div className='modal'>
                    <div className='overlay'></div>
                    <div className='content_s'>
                      ...
                      <button className='closebutton' onClick={toggleModal2}><RxCross2 /></button>
                    </div>
                  </div>
